...
public class ModOreGeneration
{
    public static void generateOres(final BiomeLoadingEvent event) {
        for (net.project.project.world.gen.OreType ore : net.project.project.world.gen.OreType.values()) {
    ...
    private static ConfiguredFeature<?, ?> registerOreFeature(net.project.project.world.gen.OreType ore, OreFeatureConfig oreFeatureConfig,
