package net.project.project.world.structure;
...
import net.project.project.world.structure.structures.Volcano;
...
public class ModStructures {
    ...
    public static final DeferredRegister<Structure<?>> STRUCTURES =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, Project.MOD_ID);

    public static final RegistryObject<Structure<NoFeatureConfig>> VOLCANO =
            STRUCTURES.register("volcano", Volcano::new);

    public static void setupStructures() {
        setupMapSpacingAndLand(VOLCANO.get(),
